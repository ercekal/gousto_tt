...
/***/ (function(module, exports, __webpack_require__) {
	...
	var middleware = (0, _redux.applyMiddleware)(_reduxThunk2.default, (0, _reduxLogger.logger)());
	var store = (0, _redux.createStore)(middleware, _reducers2.default);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _search_bar = __webpack_require__(218);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ fetchCategories: _index.fetchCategories }, dispatch);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.FETCH_CATEGORIES = undefined;
	...
	function fetchCategories() {
	  return function (dispatch) {
	    axios.get("https://api.gousto.co.uk/products/v2.0/categories").then(function (res) {
	      return res;
	    });
	    dispatch(sendCategories(res));
	  };
	}

	function sendCategories(data) {
	  return {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _reducer_categories = __webpack_require__(224);
